...
try:
    ...
    logging.info(pyautogui.center(PeaZip_1))
    ...
    logging.info(pyautogui.center(PeaZip_2))
    ...
    logging.info(pyautogui.center(PeaZip_3))
    ...
    logging.info(pyautogui.center(PeaZip_4))
